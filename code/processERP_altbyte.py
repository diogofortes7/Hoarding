...
def read_fileACQ(aFileNameandPath):
	...
	for aRowIndex in range(softArray.shape[1]):
		targTime = -1
		if softArray[1,aRowIndex] == 30 or softArray[1,aRowIndex] == 24:
		...
		if softArray[1,aRowIndex] == 11 or softArray[1,aRowIndex] == 95:
			...
			for anotherRowIndex in range(softArray.shape[1]):
				if softArray[0,anotherRowIndex] > softArray[0,aRowIndex]:
					break
				if softArray[1,anotherRowIndex] == 30 or softArray[1,anotherRowIndex] == 24:
...
##
dataDir = "/Users/diogo/Desktop/HoardingProc/weird_bytes"
import glob, os
